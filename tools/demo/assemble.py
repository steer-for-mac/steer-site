...
ap.add_argument("--chapters", required=True); ap.add_argument("--crop", default="3456:2130:0:0"); ap.add_argument("--width", type=int, default=1640); ap.add_argument("--poster", type=float, help="take time of the poster frame")
a = ap.parse_args()
...
filt = f"[0:v]crop={a.crop},setpts=PTS-STARTPTS[base];[1:v]format=rgba[o];[base][o]overlay=56:main_h-overlay_h-56:format=auto,scale={a.width}:-2,fps=30[v]"
